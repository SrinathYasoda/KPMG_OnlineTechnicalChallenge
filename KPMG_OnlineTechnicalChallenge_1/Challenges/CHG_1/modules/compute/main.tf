resource "azure_availability_set" "web_availability_set" {
    name = "web_availability_set"
    location = var.location
    reource_group_name = var.resource_group
}
...
resource "azurerm_virtual_machine" "web-vm" {
    ...
    availability_set_id = azure_availability_set.web_availability_set.id
...
resource "azure_availability_set" "app_availability_set" {
